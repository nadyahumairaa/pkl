    ...
    if(empty($_SESSION['admin'])){
        ...
        <!-- Container START -->
            <div id="colres">
                ...
                $query = mysqli_query($config, "SELECT * FROM tbl_rekomendasi WHERE id_surat='$id_surat'");
                ...
                echo '
                    <table class="bordered" id="tbl">
                        <tbody>
                            ...
                            <tr>';
                            $query3 = mysqli_query($config, "SELECT * FROM tbl_disposisi JOIN tbl_rekomendasi ON tbl_disposisi.id_surat = tbl_rekomendasi.id_surat WHERE tbl_disposisi.id_surat='$id_surat'");
