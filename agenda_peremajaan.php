    ...
    if(empty($_SESSION['admin'])){
        ...
        if(isset($_REQUEST['submit'])){
            ...
            if($_REQUEST['dari_tanggal'] == "" || $_REQUEST['sampai_tanggal'] == ""){
                header("Location: ./admin.php?page=asp");
                die();
            } else {
                ...
                echo '
                            ...
                            <div class="z-depth-1">
                                <nav class="secondary-nav">
                                    <div class="nav-wrapper blue-grey darken-1">
                                        <div class="col 12">
                                            <ul class="left">
                                                <li class="waves-effect waves-light"><a href="?page=asp" class="judul"><i class="material-icons">print</i> Cetak Agenda Surat Peremajaan<a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </nav>
                    ...
                    <h5 class="hid">AGENDA SURAT Peremajaan</h5>
                        <div class="col s10">
                            <p class="warna agenda">Agenda Surat Peremajaan dari tanggal <strong>'.indoDate($dari_tanggal).'</strong> sampai dengan tanggal <strong>'.indoDate($sampai_tanggal).'</strong></p>
                        </div>
                        <div class="col s2">
