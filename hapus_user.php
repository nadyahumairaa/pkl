    ...
    if(empty($_SESSION['admin'])){
        ...
        if($id_user == 1){
            echo '<script language="javascript">
                    ...
                    window.location.href="./admin.php?page=sett&sub=user";
                  </script>';
        } else {
        		 ...
        		 echo '
    				    ...
    				    <div class="col m12">
                            <div class="card">
                                ...
                                <div class="card-action">
            		                <a href="?page=sett&sub=user&act=del&submit=yes&id_user='.$row['id_user'].'" class="btn-large deep-orange waves-effect waves-light white-text">HAPUS <i class="material-icons">delete</i></a>
            		                <a href="?page=sett&sub=user" class="btn-large blue waves-effect waves-light white-text">BATAL <i class="material-icons">clear</i></a>
            		            </div>
                            </div>
                        </div>
                    </div>
                	...
                	if(isset($_REQUEST['submit'])){
                		...
                		if($query == true){
                            ...
                            header("Location: ./admin.php?page=sett&sub=user");
                            die();
                		} else {
                            $_SESSION['errQ'] = 'ERROR! Ada masalah dengan query';
                            echo '<script language="javascript">
                                    window.location.href="./admin.php?page=sett&sub=user&act=del&id_user='.$id_user.'";
                                  </script>';
                		}
                	}
    		        }
