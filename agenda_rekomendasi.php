    ...
    if(empty($_SESSION['admin'])){
        ...
        if(isset($_REQUEST['submit'])){
            ...
            if($_REQUEST['dari_tanggal'] == "" || $_REQUEST['sampai_tanggal'] == ""){
                header("Location: ./admin.php?page=asr");
                die();
            } else {

                $query = mysqli_query($config, "SELECT * FROM tbl_rekomendasi WHERE tgl_diterima BETWEEN '$dari_tanggal' AND '$sampai_tanggal'");
                ...
                echo '
                            ...
                            <div class="z-depth-1">
                                <nav class="secondary-nav">
                                    <div class="nav-wrapper blue-grey darken-1">
                                        <div class="col 12">
                                            <ul class="left">
                                                <li class="waves-effect waves-light"><a href="?page=asr" class="judul"><i class="material-icons">print</i> Cetak Agenda Surat Rekomendasi<a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </nav>
                    ...
                    <h5 class="hid">AGENDA SURAT REKOMENDASI</h5>
                        <div class="col s10">
                            <p class="warna agenda">Agenda Surat Rekomendasi dari tanggal <strong>'.indoDate($dari_tanggal).'</strong> sampai dengan tanggal <strong>'.indoDate($sampai_tanggal).'</strong></p>
                        </div>
                        <div class="col s2">
                        ...
                        <div class="z-depth-1">
                            <nav class="secondary-nav">
                                <div class="nav-wrapper blue-grey darken-1">
                                    <div class="col 12">
                                        <ul class="left">
                                            <li class="waves-effect waves-light"><a href="?page=asp" class="judul"><i class="material-icons">print</i> Cetak Agenda Surat Rekomendasi<a></li>
                                        </ul>
                                    </div>
                                </div>
                            </nav>
